...
export const SCENARIO_INDEX: ChapterIndex[] = [
  ...
  },
  {
    ...
    scenarios: [
      ...
      { id: 'g50', title: '枪声与复仇的终结', titleEn: 'Gunshot & End of Vengeance', startPtr: 0, bg: 'bg_10c', route: 'Haru', presets: { flag_haru: 3 } },
      { id: 'g51', title: '为了拯救哈尔的契约', titleEn: 'Contract to Save Haru', startPtr: 0, bg: 'bg_08a', route: 'Haru', presets: { flag_haru: 3 } },
      { id: 'g52', title: '警笛声中的离别', titleEn: 'Farewell in the Sirens', startPtr: 0, bg: 'bg_01a', route: 'Haru', presets: { flag_haru: 3 } },
      { id: 'g53', title: 'G弦上的魔王：狱中思念', titleEn: 'Devil on G-String: Prison Memories', startPtr: 0, bg: 'bg_10a', route: 'Haru', presets: { flag_haru: 3 } },
      { id: 'g54', title: '铁窗岁月与出狱之日', titleEn: 'Prison Years & Release Day', startPtr: 0, bg: 'bg_01a', route: 'Haru', presets: { flag_haru: 3 } },
